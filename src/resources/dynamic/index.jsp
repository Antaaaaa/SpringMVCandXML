    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li><button type="button" id="downloadXml" class="btn btn-default navbar-btn">Download</button></li>
                            <li class="dropdown">
                        ...
                        <form class="navbar-form navbar-left" action="/uploadXml" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                 <input class="custom-file-input" type="file" name="file">
                            </div>
                            <button class="btn btn-default" type="submit">Input XML</button>
                        </form>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
        ...
        <script>
            ...
            $('#downloadXml').click(function () {
                window.location.href="/downloadXml";
            })
